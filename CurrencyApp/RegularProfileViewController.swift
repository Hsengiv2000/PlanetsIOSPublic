...
import UIKit
import Kingfisher
class RegularProfileViewController: ViewController {
    ...
    private func setupConstraints() {
        ...
        logoutButton.snp.makeConstraints { make in
            make.centerX.equalToSuperview()
            make.top.equalTo(purchaseListButton.snp.bottom).offset(100)
...
extension RegularProfileViewController: UITableViewDelegate, UITableViewDataSource {
